package com.savl.bitcoin.rpc.client.examples;


import com.savl.bitcoin.rpc.client.BitcoinJSONRPCClient;
import com.savl.bitcoin.rpc.client.ExtendedTxInput;
...
import com.savl.bitcoin.rpc.client.util.BitcoinRawTxBuilder;
...
public class RawTransactionsExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ChainVerifier.ensureRunningOnChain(Chain.REGTEST, client);
